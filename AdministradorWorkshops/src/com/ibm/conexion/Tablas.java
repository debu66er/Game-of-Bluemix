...
public class Tablas {
	...
	private static String ideaSL = "CREATE TABLE IDEASL (" +
			"INSTANTE TIMESTAMP NOT NULL," +
		 	"IDEA VARCHAR(1000) NOT NULL," +
		 	"EMPRESA VARCHAR(60)," +
		 	"PRIMARY KEY (INSTANTE)" +
	...
	private static String cuestionarioSL = "CREATE TABLE CUESTIONARIOSL (" +
			"ID SERIAL NOT NULL," +
			"PREGUNTA VARCHAR(200) NOT NULL," +
			"RESP1 VARCHAR(200) NOT NULL," +
			"RESP2 VARCHAR(200) NOT NULL," +
	...
	private static String eventosSL = "CREATE TABLE EVENTOSSL (" +
			"NOMBRE VARCHAR(60) NOT NULL," +
			"LUGAR VARCHAR(60) NOT NULL," +
			"FECHA DATE NOT NULL," +
			"RESPONSABLE VARCHAR (60) NOT NULL," +
	...
	private static String enlacesSL = "CREATE TABLE ENLACESSL (" +
			"ALIAS VARCHAR(40) NOT NULL UNIQUE," +
			"CATEGORIA VARCHAR(40) NOT NULL," +
			"LINK VARCHAR(500) NOT NULL," +
			"OCULTO VARCHAR(3) NOT NULL," +
	...
	private static String materialSL = "CREATE TABLE MATERIALSL (" +
			"NOMBRE VARCHAR (40) NOT NULL UNIQUE," +
			"DESCRIPCION VARCHAR(200)," +
			"CATEGORIA VARCHAR (40)," +
			"LINK VARCHAR(500) NOT NULL," +
	...
	public static String getIdeaSL() {
		return ideaSL;
	}
	...
	public static String getCuestionarioSL() {
		return cuestionarioSL;
	}
	...
	public static String getEventosSL() {
		return eventosSL;
	}
	...
	public static String getEnlacesSL() {
		return enlacesSL;
	}
	...
	public static String getMaterialSL() {
		return materialSL;
	}
