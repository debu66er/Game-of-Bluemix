...
<html lang="es">
	...
	<body>
		...
		<div class="cuerpo">
			<h1> ¡Gracias por tu asistencia!  Nos interesan mucho tus opiniones.</h1><br><br>
			<form action="/encuesta" method="post">
				...
				<table class=form>
					...
					<tr class="par">
						<td>Antes de asistir a este seminario, ¿qué nivel de conocimiento tenías sobre la materia vista en el curso?</td>
